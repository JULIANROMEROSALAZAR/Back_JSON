...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { descripcion: @estado.descripcion, id: @estado.id } }, as: :json
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { descripcion: @estado.descripcion, id: @estado.id } }, as: :json
    assert_response 200
  end
