...
class PerfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post perfils_url, params: { perfil: { descripcion: @perfil.descripcion, id: @perfil.id } }, as: :json
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { descripcion: @perfil.descripcion, id: @perfil.id } }, as: :json
    assert_response 200
  end
